...
class Maze:
    ...
    def _break_walls_r(self,i,j):
        ...
        while True:
            print(f"at:({self._cells[i][j].get_x1()},{self._cells[i][j].get_y1()})")
            coords = []
            if i-1 >= 0:
            ...
            if len(to_visit) == 0:
                ...
                length = len(to_visit)
                if length == 4:
                    print(f"cells to move to:({to_visit[0].get_x1()},{to_visit[0].get_y1()}),({to_visit[1].get_x1()},{to_visit[1].get_y1()}),({to_visit[2].get_x1()},{to_visit[2].get_y1()}),({to_visit[3].get_x1()},{to_visit[3].get_y1()})")
                if length == 3:
                    print(f"cells to move to:({to_visit[0].get_x1()},{to_visit[0].get_y1()}),({to_visit[1].get_x1()},{to_visit[1].get_y1()}),({to_visit[2].get_x1()},{to_visit[2].get_y1()})")
                if length == 2:
                    print(f"cells to move to:({to_visit[0].get_x1()},{to_visit[0].get_y1()}),({to_visit[1].get_x1()},{to_visit[1].get_y1()})")
                if length == 1:
                    print(f"cells to move to:({to_visit[0].get_x1()},{to_visit[0].get_y1()})")
                direction = random.randint(0,length)
                print(f"moving to {to_visit[direction].get_x1()},{to_visit[direction].get_y1()} from {self._cells[i][j].get_x1()},{self._cells[i][j].get_y1()}")
                if to_visit[direction].get_x2() == self._cells[i][j].get_x1():
                    self.left_wall = False
                    i-=1
                if to_visit[direction].get_x1() == self._cells[i][j].get_x2():
                    self.right_wall = False
                    i+=1
                if to_visit[direction].get_y2() == self._cells[i][j].get_y1():
                    self.top_wall = False
                    i-=1
                if to_visit[direction].get_y1() == self._cells[i][j].get_y2():
